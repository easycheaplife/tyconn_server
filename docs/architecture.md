...
```
+-------------------------------------+
|          Partner Handler            |  ← 处理伙伴相关请求(获取列表、升级、升星等)
+-------------------------------------+
                  ↓
+-------------------------------------+
|          Partner Service            |  ← 伙伴核心逻辑(状态计算、属性计算)
+-------------------------------------+
                  ↓
+-------------------------------------+
|           Partner DAO               |  ← 伙伴数据访问(创建、查询、更新)
+-------------------------------------+
                  ↓
+-------------------------------------+
|        Cache & Database             |  ← 数据持久化与缓存
+-------------------------------------+
```
