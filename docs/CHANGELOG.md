...
- 物品合成系统
  - 添加物品合成功能，支持多种合成配方
  - 添加合成请求与响应协议 (C2G_COMPOSE_ITEM_REQUEST/G2C_COMPOSE_ITEM_RESPONSE)
  - 支持材料消耗和剩余材料返回
  - 支持多种合成配方配置
  - 添加物品合成相关错误码
...
- 物品合成相关消息
  - C2G_COMPOSE_ITEM_REQUEST (210): 物品合成请求
    - 新增target_id参数，指定需要合成的目标物品ID
    - 新增material_slots参数，指定材料物品所在格子
  - G2C_COMPOSE_ITEM_RESPONSE (211): 物品合成响应
    - 新增success参数，表示合成是否成功
    - 新增new_item参数，返回合成的新物品信息
    - 新增remain_items参数，返回剩余材料信息
